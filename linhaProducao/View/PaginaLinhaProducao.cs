...
namespace linhaProducao.View
{
    public partial class PaginaLinhaProducao : Form
    {
        public PaginaLinhaProducao()
        {
            ...
            try
            {
                LinhaProducao linhaProducoes = new LinhaProducao();

                listViewLinhaProducao.Bounds = new Rectangle(new Point(15, 70), new Size(700, 600));
                ...
                foreach (LinhaProducao linhaProducao in linhaProducoes.GetListaLinhaProducao())
                {
